...
def get_data(path):
    ...
    for ex in data:
        ...
        ex["id"] = ex.get("id", 0)
        ex["Problem"] = beautify1(ex.get("Problem", ""))
        ex["options"] = beautify2(ex.get("options", ""))
        ex["diagramRef"] = ex.get("diagramRef", "")
        ex["category"] = ex.get("category", "")
